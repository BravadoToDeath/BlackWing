...
class npc_son_of_flame_cata : public CreatureScript
{
    public:
        npc_son_of_flame_cata() :  CreatureScript("npc_son_of_flame_cata") { }

        struct npc_son_of_flame_cataAI : public ScriptedAI
        {
            npc_son_of_flame_cataAI(Creature* creature) : ScriptedAI(creature)
            {
                slowed = false;
            }
        ...
        CreatureAI* GetAI(Creature* creature) const
        {
            return new npc_son_of_flame_cataAI(creature);
        }
};
